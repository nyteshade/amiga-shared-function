...
#define WFLGS_STD_WINDOW \
  (WFLG_SIZEGADGET | WFLG_DRAGBAR | WFLG_CLOSEGADGET | WFLG_DEPTHGADGET | \
   WFLG_SMART_REFRESH | WFLG_REPORTMOUSE | WFLG_GIMMEZEROZERO | \
   WFLG_ACTIVATE | WFLG_RMBTRAP)

#define WFLGS_STD_WINDOW_V36 (WFLGS_STD_WINDOW | WFLG_NW_EXTENDED)
#define WFLGS_STD_WINDOW_V39 (WFLGS_STD_WINDOW_V36 | WFLG_NEWLOOKMENUS)
